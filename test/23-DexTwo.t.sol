...
contract DexTwoTest is DSTest {
    ...
    function testDexTwoHack() public {
        ...
        emit log_named_uint(
            "The hacker's balance of malicious token1", ethernautDexTwo.balanceOf(address(maliciousToken1), hacker)
        );
        emit log_named_uint(
            "The hacker's balance of malicious token2", ethernautDexTwo.balanceOf(address(maliciousToken2), hacker)
        );
        ...
        emit log_named_uint(
            "The balance of malicious token1 in dexTwo",
            ethernautDexTwo.balanceOf(address(maliciousToken1), levelAddress)
        );
        emit log_named_uint(
            "The balance of malicious token2 in dexTwo",
            ethernautDexTwo.balanceOf(address(maliciousToken2), levelAddress)
        );
        ...
        emit log_named_uint("The balance of token2 in the DEXTwo", ethernautDexTwo.balanceOf(token2, levelAddress));
        emit log_named_uint(
            "The balance of malicious token1 in the DEXTwo",
            ethernautDexTwo.balanceOf(address(maliciousToken1), levelAddress)
        );
        emit log_named_uint(
            "The balance of malicious token2 in the DEXTwo",
            ethernautDexTwo.balanceOf(address(maliciousToken2), levelAddress)
        );
